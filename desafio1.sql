...
CREATE TABLE SpotifyClone.plano(
    ...
    valor_do_plano DECIMAL(6, 2) NOT NULL
    )engine = InnoDB;
    
INSERT INTO SpotifyClone.plano(nome_plano, valor_do_plano)
VALUES
  ('gratuito', 0),
  ('familiar', 7.99),
  ('universitário', 5.99),
...
INSERT INTO SpotifyClone.usuario(nome_usuario, idade, plano_id, data_da_assinatura)
VALUES
...
INSERT INTO SpotifyClone.album(nome_album, artista_id, lancamento)
VALUES
  ('Envious', 1, 1990),
  ('Exuberant', 1, 1993),
...
INSERT INTO SpotifyClone.historico_de_reproducao(usuario_id, cancao_id, data_de_reproducao)
VALUES
	...
	(10, 20, DATE('2020-04-01 03:36:00')),
